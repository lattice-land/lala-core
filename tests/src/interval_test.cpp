...
TEST(IntervalTest, JoinMeetTest) {
  ...
  EXPECT_EQ(fjoin(Itv(10, 20), Itv(4,14)), Itv(10,14));
  EXPECT_EQ(fmeet(Itv(10, 20), Itv(4,14)), Itv(4,20));

  EXPECT_EQ(fmeet(Itv(1, 9), Itv(11,10)), Itv(1, 9));
  EXPECT_EQ(fjoin(Itv(1, 9), Itv(11,10)), Itv(11, 9));
}
...
TEST(IntervalTest, MinMax) {
  EXPECT_EQ((project_fun(MIN, Itv::bot(), Itv(-10, 10))), Itv(zi::bot(), zd(10)));
  EXPECT_EQ((project_fun(MIN, Itv(-10, 10), Itv::bot())), Itv(zi::bot(), zd(10)));
  EXPECT_EQ((project_fun(MAX, Itv::bot(), Itv(-10, 10))), Itv(zi(-10), zd::bot()));
  EXPECT_EQ((project_fun(MAX, Itv(-10, 10), Itv::bot())), Itv(zi(-10), zd::bot()));
}
...
TEST(IntervalTest, Multiplication) {
  ...
  EXPECT_EQ((project_fun(MUL, Itv(-10, 10), Itv(9, -9))), Itv::top());
  EXPECT_EQ((project_fun(MUL, Itv(9, -9), Itv(-10, 10))), Itv::top());
}
...
TEST(IntervalTest, EuclideanDivision) {
  ...
  EXPECT_EQ((project_fun(EDIV, Itv(0, 1), Itv(0, 0))), Itv::top());
  ...
  EXPECT_EQ((project_fun(EDIV, Itv(-1, 1), Itv(0, 0))), Itv::top());
  EXPECT_EQ((project_fun(EDIV, Itv(-1, 1), Itv(1, 1))), Itv(-1, 1));
  EXPECT_EQ((project_fun(EDIV, Itv(-1, 1), Itv(-1, 1))), Itv(-1, 1));

  EXPECT_EQ((project_fun(EDIV, Itv(-1, 0), Itv(0, 1))), Itv(-1, 0));
  EXPECT_EQ((project_fun(EDIV, Itv(-1, 0), Itv(0, 0))), Itv::top());
